...
SECRET_KEY = 'yl9*4b3!&+n&#8wqf@8kxe&z9l=!#odid7oa=&=661s+z0cp6+'
...
#(MEDIA_ROOT) that have been uploaded and stored, and what URL to serve them from (MEDIA_URL)
##ie http://localhost:8000/media/sample.pdf if we wanted to get sample.pdf
